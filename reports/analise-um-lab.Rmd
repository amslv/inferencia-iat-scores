...
Em média, as mulheres que participaram do experimento tiveram uma associação implícita (medida pelo IAT) com a matemárica **negativa** e **forte** (média 0.5, desv. padrão 0.33, N = 51). Homens tiveram uma associação **negativa** e **média** com a matemática, portanto **menor** que a das mulheres (média 0.36, desv. padrão 0.39, N = 25). Houve portanto uma **pequena** diferença entre homens e mulheres (diferença das médias 0.14, 95% CI [-0.33, 0.023]). A partir desta amostra, estimamos que mulheres têm uma associação negativa mais forte, porém não é claro se essa diferença é grande, moderada ou pequena. É necessário coletar mais dados para determinar se a diferença é relevante ou negligenciável.
